...
public class Point{
  ...
  @Override
  public String toString(){ // when you override toString, make it into a meaningful output 
    return "The coordinates of this point object are: (x = " + getX() + ", " + "y = " + getY() + ")";
  }

  public static void main(String[] args){
    Point point1 = new Point();
    System.out.println(point1); // By default toString() inhereted from Objects will print the memory reference for non primitive data types
  }
